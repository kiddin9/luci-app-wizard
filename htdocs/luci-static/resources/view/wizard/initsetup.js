...
return view.extend({
	...
	getSystemConfig: function() {
		...
		return {
			...
			lan_ipaddr: getFirstIp(uci.get('network', 'lan', 'ipaddr'), '192.168.1.1'),
	...
	render: function(data) {
		...
		var opt, fields = [
			...
			{ tab: 'netsetup', type: form.Value, id: 'lan_ipaddr', title: _('LAN IPv4 Address'), datatype: 'ip4addr', placeholder: '192.168.1.1' },
			{ tab: 'netsetup', type: form.DynamicList, id: 'lan_dns', title: _('Custom DNS Server(s)'), datatype: 'ipaddr', placeholder: '119.29.29.29' },
			{ tab: 'netsetup', type: form.Value, id: 'lan_gateway', title: _('Gateway Address'), datatype: 'ip4addr', placeholder: '192.168.1.254', depends: { wan_proto: 'siderouter' }, desc: _('Primary router IP address used when operating in side-router mode.') },
